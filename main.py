...
# ----------------------------
GRAPH_URL  = os.getenv("GRAPH_URL")   # e.g. https://.../dhaka_min.gpickle.gz or .graphml.gz
LGBM_URL   = os.getenv("LGBM_URL")    # joblib dump of LightGBM model
SCALER_URL = os.getenv("SCALER_URL")  # joblib dump of sklearn scaler
KMEANS_URL = os.getenv("KMEANS_URL")  # joblib dump of sklearn KMeans
